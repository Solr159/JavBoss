...
JavBoss 旨在为用户屏蔽掉所有繁琐的信息收集和整理的底层细节，让用户能够把有限的精力放在更有意义的浏览、收藏、看片上。
...
- [macOS-x86_64](https://github.com/Solr159/JavBoss/releases/download/v1.8.4/javboss-v1.8.4-macos-x86_64.zip)（适用于 Intel 芯片的 macOS）
- [macOS-arm64](https://github.com/Solr159/JavBoss/releases/download/v1.8.4/javboss-v1.8.4-macos-arm64.zip)（适用于 M 芯片的 macOS）
