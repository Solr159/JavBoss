...
func RegisterRoutes(router gin.IRoutes) {
	...
	router.POST("/videos/media-category", updateVideoMediaCategories)
	...
	router.GET("/videos/:id/western-scrape/search", searchVideoWesternMetadata)
	router.PUT("/videos/:id/western-scrape", saveVideoWesternMetadata)
	router.DELETE("/videos/:id/western-scrape", deleteVideoWesternMetadata)
	router.GET("/western/:kind", listWesternEntities)
