...
func RegisterRoutes(router gin.IRoutes) {
	...
	router.GET("/jav/discovery/subscriptions", listJavDiscoverySubscriptions)
	router.POST("/jav/discovery/subscriptions", createJavDiscoverySubscription)
	router.POST("/jav/discovery/subscriptions/:id/history", loadMoreJavDiscoverySubscriptionHistory)
	...
	router.POST("/jav/discovery/items/:id/downloads", createDiscoveryDownload)
	router.POST("/jav/discovery/sync", triggerJavDiscoverySync)
	router.GET("/jav/downloader/settings", getDownloaderSettings)
	router.PUT("/jav/downloader/settings", updateDownloaderSettings)
	router.PUT("/jav/downloader/providers/:provider", updateDownloaderProviderSettings)
	router.GET("/jav/downloader/providers/:provider/token", getDownloaderProviderToken)
	router.POST("/jav/downloader/providers/:provider/test", testDownloaderProvider)
	router.GET("/jav/downloads", listDownloadJobs)
	router.POST("/jav/downloads", createSourceFreeDownload)
	router.POST("/jav/downloads/:id/retry", retryDownloadJob)
	router.POST("/jav/downloads/:id/cancel", cancelDownloadJob)
	router.DELETE("/jav/downloads/:id", deleteDownloadJob)
