...
type Video struct {
	...
	MediaCategory       string           `json:"media_category" gorm:"not null;default:auto;index"`
	Tags                []Tag            `json:"tags,omitempty" gorm:"many2many:video_tag"`
	JavID               *int64           `json:"jav_id" gorm:"-"`
	Jav                 *Jav             `json:"jav,omitempty" gorm:"-"`
	WesternMetadata     *WesternMetadata `json:"western_metadata,omitempty" gorm:"foreignKey:VideoID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE"`
...
const (
	MediaCategoryAuto    = "auto"
	MediaCategoryJAV     = "jav"
	MediaCategoryWestern = "western"
)
