...
如需从任意 HTTP/HTTPS 网站直接提交磁力下载任务，请先点击浏览器工具栏中的 **JavBoss 助手**，填写 JavBoss Server 地址（例如 `http://127.0.0.1:17654`），打开 **启用磁力下载** 并保存。此功能默认关闭；启用后点击磁力链接会先显示确认询问，确认后才会提交到 JavBoss 下载队列。
